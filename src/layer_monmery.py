...
class hypergraph_part(nn.Module):
    def __init__(self, in_channels, out_channels, device):
        ...
        self.linear_layer = nn.Linear(in_features=128, out_features=64, bias=False)#######128->in_features修改为2*32 out_features修改为32
    ...
    def forward(self, c_it, medicine_it, c_embeddings, m_embeddings,pretrain_model):
        ...
        #                                                                        m_embeddings)
        dia_med_hyperedges, dia_med_emb, dia_med_hyperedge_attr = dual_hypergraphs(c_it, medicine_it, dia_embedding,
                                                                               med_embedding)
...
def dual_hypergraphs(c_it, med_it, c_embeddings, m_embeddings):
    ...
    disease_embeddings = c_embeddings
    # med_embeddings = m_embeddings[med_it]
    med_embeddings = m_embeddings
